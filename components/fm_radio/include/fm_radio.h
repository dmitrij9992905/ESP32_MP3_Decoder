...
#ifndef _FM_RADIO_H_INCLUDED
#define _FM_RADIO_H_INCLUDED
...
const uint16_t RDA5807M_BandLowerLimits[5];
const uint16_t RDA5807M_BandHigherLimits[5];
const uint8_t RDA5807M_ChannelSpacings[4];
